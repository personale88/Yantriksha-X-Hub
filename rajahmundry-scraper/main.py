...
def main():
    parser = argparse.ArgumentParser(description="Rajahmundry Jewellery Shops Scraper Pipeline CLI")
    
    parser.add_argument("--job", type=str, default="rajahmundry_jewellery", 
                        help="Scraper job name (default: rajahmundry_jewellery)")
