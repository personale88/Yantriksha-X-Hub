...
def main():
    parser = argparse.ArgumentParser(description="Srikakulam Jewellery Shops Scraper Pipeline CLI")
    
    parser.add_argument("--job", type=str, default="srikakulam_jewellery", 
                        help="Scraper job name (default: srikakulam_jewellery)")
