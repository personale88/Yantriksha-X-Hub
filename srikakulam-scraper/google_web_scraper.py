...
RAW_DIR = "output/raw/srikakulam_jewellery/google"
STATE_FILE = "output/logs/srikakulam_jewellery_google_state.json"

def init_dirs():
    os.makedirs(RAW_DIR, exist_ok=True)
    os.makedirs(os.path.dirname(STATE_FILE), exist_ok=True)

# Define dense grid zones in Srikakulam
NEIGHBORHOODS = [
    "Srikakulam Central", "7 Road Junction", "Balaga Colony", "PN Colony", "Day & Night Junction",
    "GT Road", "Arasavalli", "Peddapadu", "Singupuram", "Koti Junction", "Amadalavalasa",
    "Gujarathipeta", "Palasa", "Narasannapeta", "Rajam", "Etcherla", "Khazipeta", "Illisipuram",
    "Ramachandra Nagar", "Housing Board Colony", "Visakha A-Colony", "Ranasthalam", "Ponduru",
    "Kasibugga", "Sompeta", "Ichchapuram", "Tekkali", "Pathapatnam", "Mandasa", "Harischandrapuram",
    "Hiramandalam", "Kotabommali", "Kanchili", "Jalumuru", "Sarubujjili", "Gara", "Polaki",
    "Laveru", "Kavititi", "Palakonda", "Seethampeta", "Veeraghattam", "Vangara"
]
...
for area in NEIGHBORHOODS:
    for kw in KEYWORDS:
        SEARCH_QUERIES.append(f"{kw} in {area} Srikakulam")

# Add broad category searches
BROAD_QUERIES = [
    "Jewellery Shop Srikakulam",
    "Jewellers Srikakulam",
    "Gold Shop Srikakulam",
    "Silver Shop Srikakulam",
    "Diamond Store Srikakulam",
    "Bridal Jewellery Srikakulam",
    "Wedding Jewellery Srikakulam",
    "Hallmark Jewellery Srikakulam",
    "Luxury Jewellery Srikakulam",
    "Precious Metal Dealers Srikakulam",
    "Gold Merchants Srikakulam",
    "Gold Dealers Srikakulam",
    "Traditional Jewellery Srikakulam",
    "Fashion Jewellery Srikakulam"
]
...
def run_google_web_scrape():
    ...
    print(f"[Google Web Scraper] Starting dense search query loop for Srikakulam ({len(unique_places)} places loaded)...")
                    ...
                    try:
                        ...
                        try:
                            ...
                            for text in text_blocks:
                                ...
                                for line in lines:
                                    if any(k in line.lower() for k in ["srikakulam", "street", "road", "bazaar", "nagar", "opposite", "near", "circle"]):
                        ...
                        unique_places[place_id] = {
                            ...
                            "address": address if address else "Srikakulam, Andhra Pradesh",
                            "phone": phone,
                            "maps_url": href,
                            "place_id": place_id
                        }
