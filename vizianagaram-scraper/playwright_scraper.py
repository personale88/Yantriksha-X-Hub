...
RAW_DIR = "output/raw/vizianagaram_jewellery/justdial"
LOG_DIR = "output/logs"
STATE_FILE = os.path.join(LOG_DIR, "vizianagaram_jewellery_jd_state.json")
...
def run_playwright_jd_scrape():
    ...
    with sync_playwright() as p:
        ...
        page.goto("https://www.justdial.com/Vizianagaram/Jewellery-Showrooms/nct-10282098", wait_until="domcontentloaded")
        time.sleep(6)
