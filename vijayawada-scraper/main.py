...
def main():
    parser = argparse.ArgumentParser(description="Vijayawada Jewellery Shops Scraper Pipeline CLI")
    
    parser.add_argument("--job", type=str, default="vijayawada_jewellery", 
                        help="Scraper job name (default: vijayawada_jewellery)")
