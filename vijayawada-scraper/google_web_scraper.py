...
RAW_DIR = "output/raw/vijayawada_jewellery/google"
STATE_FILE = "output/logs/vijayawada_jewellery_google_state.json"

def init_dirs():
    os.makedirs(RAW_DIR, exist_ok=True)
    os.makedirs(os.path.dirname(STATE_FILE), exist_ok=True)

# Define neighborhoods in Vijayawada
NEIGHBORHOODS = [
    "Benz Circle", "Governorpet", "MG Road", "Eluru Road", "One Town", "Gandhinagar", 
    "Labbipet", "Patamata", "Gunadala", "Poranki", "Kanuru", "Gollapudi", "Bhavanipuram", 
    "Ajit Singh Nagar", "Auto Nagar", "Currency Nagar", "Moghalrajpuram", "Krishna Lanka", 
    "Tadepalli", "Enikepadu", "Nidamanuru", "Ramavarappadu", "Vijayawada Rural"
]
...
for area in NEIGHBORHOODS:
    for kw in KEYWORDS:
        SEARCH_QUERIES.append(f"{kw} in {area} Vijayawada")

# Add broad category searches
BROAD_QUERIES = [
    "Jewellery Shop Vijayawada",
    "Jewellers Vijayawada",
    "Gold Shop Vijayawada",
    "Silver Shop Vijayawada",
    "Diamond Store Vijayawada",
    "Bridal Jewellery Vijayawada",
    "Wedding Jewellery Vijayawada",
    "Hallmark Jewellery Vijayawada",
    "Luxury Jewellery Vijayawada",
    "Precious Metal Dealers Vijayawada",
    "Gold Merchants Vijayawada",
    "Gold Dealers Vijayawada",
    "Traditional Jewellery Vijayawada",
    "Fashion Jewellery Vijayawada"
]
...
def run_google_web_scrape():
    ...
    print(f"[Google Web Scraper] Starting dense search query loop for Vijayawada ({len(unique_places)} places loaded)...")
    ...
    with sync_playwright() as p:
        ...
        for q_idx, query in enumerate(SEARCH_QUERIES, 1):
            ...
            try:
                ...
                scroll_attempts = 0
                max_attempts = 15  # Limit scrolls per query to keep the loop fast but comprehensive
                    ...
                    try:
                        ...
                        try:
                            ...
                            for text in text_blocks:
                                ...
                                for line in lines:
                                    if any(k in line.lower() for k in ["vijayawada", "street", "road", "bazaar", "nagar", "opposite", "near", "circle"]):
                        ...
                        unique_places[place_id] = {
                            ...
                            "address": address if address else "Vijayawada, Andhra Pradesh",
                            "phone": phone,
                            "maps_url": href,
                            "place_id": place_id
                        }
