...
RAW_GOOGLE_DIR = "output/raw/tirupati_jewellery/google"
RAW_JD_DIR = "output/raw/tirupati_jewellery/justdial"
MERGED_DIR = "output/merged/tirupati_jewellery"
...
def run_merge():
    ...
    if not df_google.empty:
        df_google.to_csv(os.path.join(MERGED_DIR, "tirupati_jewellery_google_all.csv"), index=False, encoding="utf-8-sig")
    if not df_jd.empty:
        df_jd.to_csv(os.path.join(MERGED_DIR, "tirupati_jewellery_justdial_all.csv"), index=False, encoding="utf-8-sig")
    ...
    # Save files
    merged_csv = os.path.join(MERGED_DIR, "tirupati_jewellery_merged.csv")
    merged_json = os.path.join(MERGED_DIR, "tirupati_jewellery_merged.json")
    merged_xlsx = os.path.join(MERGED_DIR, "tirupati_jewellery_merged.xlsx")
    backup_csv = os.path.join(MERGED_DIR, "tirupati_jewellery_merged_backup.csv")
