...
def main():
    parser = argparse.ArgumentParser(description="Tirupati Jewellery Shops Scraper Pipeline CLI")
    
    parser.add_argument("--job", type=str, default="tirupati_jewellery", 
                        help="Scraper job name (default: tirupati_jewellery)")
